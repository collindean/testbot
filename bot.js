...
function respond() {
  ...
  if (usrInput.search(botFight || botHands || botCatch) > -1) {
...
function fightMessage () {
	...
	if (randNum == 1) {
		...
		botResponse = "What the fuck did you just fucking say about me, you little bitch? I’ll have you know I graduated top of my class in the Navy Seals, and I’ve been involved in numerous secret raids on Al-Quaeda, and I have over 300 confirmed kills. I am trained in gorilla warfare and I’m the top sniper in the entire US armed forces. You are nothing to me but just another target.";
	} else {
		botResponse = "calm down there lil kid";
	}
...
var slicedText = usrInput.trim().slice(8);
